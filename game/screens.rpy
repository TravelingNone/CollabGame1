...
image main_base = ConditionSwitch(
    "hope == True", "menuHovering",
    "hope == False", "menuIdle.jpg")
default hope = False
...
screen main_menu():
    ...
    window:
        style "mm_root"
        add "main_base"
# If you don't like the ConditionSwitch for some reason, could also just do the if on the main menu base image only like so:
#        if hope:
#            add "menuHovering"
#        else:
#            add "menuIdle.jpg"
    ...
    frame:
        ...
        imagebutton:
            idle "NewGame_Idle.png"
            hover "NewGame_Hover.png"
            hovered SetVariable("hope", True)
            unhovered SetVariable ("hope", False)
            action Start()
        imagebutton:
            idle "Continue_Idle.png"
            hover "Continue_Hover.png"
            hovered SetVariable("hope", True)
            unhovered SetVariable ("hope", False)
        ...
        imagebutton:
            idle "Gallery_Idle.png"
            hover "Gallery_Hover.png"
            hovered SetVariable("hope", True)
            unhovered SetVariable ("hope", False)
    ...
    grid 3 1:
        ...
        vbox:
            ...
            frame:
                ...
                label _("Show Bestiality")
                textbutton _("Show") action SetField(persistent, "Bestiality", True)
                textbutton _("Hide") action SetField(persistent, "Bestiality", False)
